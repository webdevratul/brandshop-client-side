            ...
            <div className="w-[70%] mx-auto text-gray-500 py-24">
                <div className="flex justify-center flex-col xl:flex-row items-center gap-8">
                    <div className="w-[100%] md:w-[70%] xl:w-[40%] text-center xl:text-start">
                        ...
                        <button className="mx-auto bg-black border-4 border-[#FFD32B] py-4 px-8 text-white font-semibold rounded-full text-xl font-serif my-8">More About Us <FaAnglesRight className="inline"></FaAnglesRight></button>
                    </div>
